...
def dataset_loader_splitter(dataset_id, base_path, split_index):
    ...
    split_path_train = "/train_" + dataset_id + "_" + str(split_index) + "_10percent.npy"
    split_path_val = "/validation_" + dataset_id + "_" + str(split_index) + "_10percent.npy"
    split_path_test = "/test_" + dataset_id + "_" + str(split_index) + "_10percent.npy"
